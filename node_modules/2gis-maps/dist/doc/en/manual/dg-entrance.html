<h2 id="dgentrance">DG.Entrance</h2><p>Allows to display an entrance to the building. The class supports simple animation and multiple inputs display.
Objects of entrances themselves represent arrows which change their scale together with zooming, but not lower
than the level 16, after which the arrows disappear from the map (until reaching an acceptable level of zooming).</p>
<p><dl class="api-incut"><ul class="page-contents"><li><a href="#dgentrance">DG.Entrance</a><ul><li><a href="#example-of usage">Example of usage</a></li><li><a href="#creation">Creation</a></li><li><a href="#options">Options</a></li><li><a href="#methods">Methods</a></li></ul></dl></p>
<h3 id="dgentrance-1">DG.Entrance</h3><h4 id="example-of usage">Example of usage</h4><p>Create and display the entrances to the building:</p>
