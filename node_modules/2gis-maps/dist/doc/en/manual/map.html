<h2 id="map">Map</h2><p>This section describes the central class of the maps API which is used to create a map on a page and manipulate it.</p>
<p><dl class="api-incut"><ul class="page-contents"><li><a href="#dgmap">DG.Map</a><ul><li><a href="#usage-example">Usage example</a></li><li><a href="#creation">Creation</a></li><li><a href="#options">Options</a><ul><li><a href="#control-options">Control Options</a></li><li><a href="#interaction-options">Interaction Options</a></li><li><a href="#map-state options">Map State Options</a></li><li><a href="#animation-options">Animation Options</a></li><li><a href="#panning-inertia options">Panning Inertia Options</a></li><li><a href="#keyboard-navigation options">Keyboard Navigation Options</a></li><li><a href="#mousewheel-options">Mousewheel options</a></li><li><a href="#touch-interaction options">Touch interaction options</a></li></ul></li><li><a href="#events">Events</a><ul><li><a href="#layer-events">Layer events</a></li><li><a href="#map-state change events">Map state change events</a></li><li><a href="#popup-events">Popup events</a></li><li><a href="#interaction-events">Interaction events</a></li><li><a href="#animation-events">Animation Events</a></li><li><a href="#location-events">Location Events</a></li></ul></li><li><a href="#methods">Methods</a><ul><li><a href="#methods-for layers and controls">Methods for Layers and Controls</a></li><li><a href="#methods-for modifying map state">Methods for modifying map state</a></li><li><a href="#other-methods">Other Methods</a></li><li><a href="#methods-for getting map state">Methods for Getting Map State</a></li><li><a href="#conversion-methods">Conversion Methods</a></li><li><a href="#geolocation-methods">Geolocation methods</a></li><li><a href="#methods-inherited from evented">Methods inherited from Evented</a></li></ul></li><li><a href="#properties">Properties</a><ul><li><a href="#handlers">Handlers</a></li><li><a href="#map-panes">Map panes</a></li><li><a href="#locate-options">Locate options</a></li><li><a href="#zoom-options">Zoom options</a></li><li><a href="#pan-options">Pan options</a></li><li><a href="#zoom/pan-options">Zoom/pan options</a></li><li><a href="#fitbounds-options">FitBounds options</a></li></ul></dl></p>
<h3 id="dgmap">DG.Map</h3><h4 id="usage-example">Usage example</h4><p>Initialize the map on the &quot;map&quot; div with a given center and zoom:</p>
...
<h5 id="control-options">Control Options</h5><table>
    <thead>
        <tr>
            <th>Option</th>
            <th>Type</th>
...
<h5 id="interaction-options">Interaction Options</h5><table>
    <thead>
        <tr>
            <th>Option</th>
            <th>Type</th>
...
<h5 id="map-state options">Map State Options</h5><table>
    <thead>
        <tr>
            <th>Option</th>
            <th>Type</th>
...
<h5 id="animation-options">Animation Options</h5><table>
    <thead>
        <tr>
            <th>Option</th>
            <th>Type</th>
...
<h5 id="panning-inertia options">Panning Inertia Options</h5><table>
    <thead>
    <tr>
        <th>Option</th>
        <th>Type</th>
...
<h5 id="keyboard-navigation options">Keyboard Navigation Options</h5><table>
    <thead>
        <tr>
            <th>Option</th>
            <th>Type</th>
...
<h5 id="mousewheel-options">Mousewheel options</h5><table>
    <thead>
        <tr>
            <th>Option</th>
            <th>Type</th>
...
<h5 id="touch-interaction options">Touch interaction options</h5><table>
    <thead>
        <tr>
            <th>Option</th>
            <th>Type</th>
...
<h4 id="events">Events</h4><h5 id="layer-events">Layer events</h5><table>
    <thead>
        <tr>
            <th>Event</th>
            <th>Data</th>
...
<h5 id="map-state change events">Map state change events</h5><table>
    <thead>
        <tr>
            <th>Event</th>
            <th>Data</th>
...
<h5 id="popup-events">Popup events</h5><table>
    <thead>
        <tr>
            <th>Event</th>
            <th>Data</th>
...
<h5 id="interaction-events">Interaction events</h5><table>
    <thead>
        <tr>
            <th>Event</th>
            <th>Data</th>
...
<h5 id="animation-events">Animation Events</h5><table>
    <thead>
        <tr>
            <th>Event</th>
            <th>Data</th>
...
<h5 id="location-events">Location Events</h5><table>
    <thead>
        <tr>
            <th>Event</th>
            <th>Data</th>
...
<h5 id="methods-for layers and controls">Methods for Layers and Controls</h5><table>
    <thead>
        <tr>
            <th>Method</th>
            <th>Returns</th>
...
<h5 id="methods-for modifying map state">Methods for modifying map state</h5><table>
    <thead>
        <tr>
            <th>Method</th>
            <th>Returns</th>
...
<h5 id="other-methods">Other Methods</h5><table>
    <thead>
        <tr>
            <th>Method</th>
            <th>Returns</th>
...
<h5 id="methods-for getting map state">Methods for Getting Map State</h5><table>
    <thead>
        <tr>
            <th>Method</th>
            <th>Returns</th>
...
<h5 id="conversion-methods">Conversion Methods</h5><table>
    <thead>
        <tr>
            <th>Method</th>
            <th>Returns</th>
...
<h5 id="geolocation-methods">Geolocation methods</h5><table>
    <thead>
        <tr>
            <th>Method</th>
            <th>Returns</th>
...
<h5 id="methods-inherited from evented">Methods inherited from Evented</h5><p>Methods inherited from Evented see <a href="/doc/maps/en/manual/base-classes#dgevented-methods">here</a>.</p>
<h3 id="properties">Properties</h3><!-- TODO: translation -->
<h4 id="handlers">Handlers</h4><table>
    <thead>
        <tr>
            <th>Property</th>
            <th>Type</th>
...
<h4 id="map-panes">Map panes</h4><p>Panes are DOM elements used to control the ordering of layers on the map. You
...
Every map has the following default panes that differ only in zIndex.</p>
<table>
    <thead>
        <tr>
            <th>Pane</th>
...
<h4 id="locate-options">Locate options</h4><p>Some of the geolocation methods for <a href="#dgmap"><code>Map</code></a> take in an <code>options</code> parameter.
This is a plain javascript object with the following optional components:</p>
<table>
    <thead>
        <tr>
            <th>Option</th>
...
<h4 id="zoom-options">Zoom options</h4><p>Some of the <a href="#dgmap"><code>Map</code></a> methods which modify the zoom level take in an <code>options</code>
...
<h4 id="pan-options">Pan options</h4><p>Some of the <a href="#map"><code>Map</code></a> methods which modify the center of the map take in an
<code>options</code> parameter. This is a plain javascript object with the following optional components:</p>
<table>
    <thead>
        <tr>
            <th>Option</th>
...
<h4 id="zoom/pan-options">Zoom/pan options</h4><p>Options inherited from <a href="#zoom-options">Zoom options</a></p>
<p>Options inherited from <a href="#pan-options">Pan options</a></p>
<h4 id="fitbounds-options">FitBounds options</h4><table>
    <thead>
        <tr>
            <th>Option</th>
            <th>Type</th>
