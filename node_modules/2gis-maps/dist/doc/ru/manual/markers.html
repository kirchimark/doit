...
<h4 id="события">События</h4><table>
    <thead>
        <tr>
            <th>Событие</th>
            <th>Данные</th>
...
<h5 id="события-перетаскивания">События перетаскивания</h5><table>
    <thead>
        <tr>
            <th>Событие</th>
            <th>Данные</th>
...
<p>События, унаследованные от <a href="/doc/maps/ru/manual/base-classes#dglayer-events">Layer</a> <!-- TODO: include events --></p>
<table>
    <thead>
        <tr>
            <th>Событие</th>
...
<h4 id="обработчики-взаимодействия">Обработчики взаимодействия</h4><p>Свойства маркера включают в себя обработчики взаимодействия, которые позволяют контролировать
интерактивное поведение маркера, а также подключение и отключение определенных возможностей,
таких как перетаскивание (см. методы Handler). Например:</p>
<pre><code>marker.dragging.disable();
</code></pre><table>
    <thead>
        <tr>
            <th>Свойство</th>
...
<h3 id="dgicon">DG.Icon</h3><p>Иконка, которую можно использовать при создании маркера. Например:</p>
...
<h4 id="опции-1">Опции</h4><table id="dgicon-options">
    <thead>
        <tr>
            <th>Опция</th>
            <th>Тип</th>
...
<p>События попапа, унаследованные от <a href="/doc/maps/ru/manual/base-classes#dglayer-popup-events">Layer</a> <!-- TODO: include popup events --></p>
<h4 id="методы-1">Методы</h4><table id="dgicon-methods">
    <thead>
        <tr>
            <th>Метод</th>
            <th>Возвращает</th>
...
<p>Методы, унаследованные от <a href="/doc/maps/ru/manual/base-classes#dglayer-methods">Layer</a> <!-- TODO: include methods --></p>
<p>Методы, унаследованные от <a href="/doc/maps/ru/manual/base-classes#dgevented-methods">Evented</a> <!-- TODO: include methods --></p>
<h3 id="dgdivicon">DG.DivIcon</h3><p>Иконка для маркеров, которые используют простой элемент <code>&lt;div&gt;</code> вместо изображения.
Наследуется от <a href="#dgicon"><code>Icon</code></a>, но игнорирует опции теней и <code>iconUrl</code>.</p>
<pre><code>// вы можете установить стиль класса .my-div-icon в CSS
...
<p>Опции, унаследованные от <a href="#dgicon-options">Icon</a> <!-- TODO: include options --></p>
<p>Опции, унаследованные от <a href="/doc/maps/ru/manual/base-classes#dglayer-options">Layer</a> <!-- TODO: include options --></p>
...
<p>События попапа, унаследованные от <a href="/doc/maps/ru/manual/base-classes#dglayer-popup-events">Layer</a> <!-- TODO: include popup events --></p>
<h4 id="методы-2">Методы</h4><p>Методы, унаследованные от <a href="#dgicon-methods">Icon</a> <!-- TODO: include methods --></p>
<p>Методы попапа, унаследованные от <a href="/doc/maps/ru/manual/base-classes#dglayer-popup-methods">Layer</a> <!-- TODO: include methods --></p>
<p>Методы, унаследованные от <a href="/doc/maps/ru/manual/base-classes#dglayer-methods">Layer</a> <!-- TODO: include methods --></p>
<p>Методы, унаследованные от <a href="/doc/maps/ru/manual/base-classes#dgevented-methods">Evented</a> <!-- TODO: include methods --></p>
