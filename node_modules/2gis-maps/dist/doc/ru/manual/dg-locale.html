...
<h3 id="описание">Описание</h3><p>API карт предоставляет возможность отображения элементов пользовательского интерфейса на нескольких языках.
Перевод самих тайлов при этом не предусмотрен, так как подписи на тайлах всегда соответствуют языку отображаемой страны.</p>
...
</code></pre><p>На данный момент поддерживаются следующие языки:</p>
<ul class="list-v-disc">
<li><div class="restore-color">en &mdash; английский;</div></li><li><div class="restore-color">ru &mdash; русский;</div></li><li><div class="restore-color">it &mdash; итальянский;</div></li><li><div class="restore-color">cs &mdash; чешский;</div></li><li><div class="restore-color">es &mdash; испанский.</div></li></ul>
