<h2 id="подключение-api">Подключение API</h2><p><dl class="api-incut"><ul class="page-contents"><li><a href="#описание">Описание</a></li><li><a href="#простой-способ">Простой способ</a></li><li><a href="#npm">npm</a></li><li><a href="#react-компонент">React-компонент</a></li><li><a href="#загрузка-по требованию">Загрузка по требованию</a></li><li><a href="#опции-подключения">Опции подключения</a></li><li><a href="#функция-dgthen">Функция DG.then</a></li></ul></dl></p>
...
<h3 id="react-компонент">React-компонент</h3><p>Также вы можете воспользоваться нашим <a href="https://github.com/2gis/2gis-maps-react">React-компонентом</a>
для работы с картой в декларативном стиле с помощью библиотеки <a href="https://github.com/facebook/react">React</a>.</p>
