...
<h5 id="другие-методы">Другие методы</h5><table>
    <thead>
        <tr>
            <th>Метод</th>
            <th>Возвращает</th>
...
<h5 id="методы-получения состояния карты">Методы получения состояния карты</h5><table>
    <thead>
        <tr>
            <th>Метод</th>
            <th>Возвращает</th>
...
<h5 id="методы-преобразования">Методы преобразования</h5><table>
    <thead>
        <tr>
            <th>Метод</th>
            <th>Возвращает</th>
...
<h5 id="методы-геолокации">Методы геолокации</h5><table>
    <thead>
        <tr>
            <th>Метод</th>
            <th>Возвращает</th>
...
<h5 id="методы,-унаследованные от evented">Методы, унаследованные от Evented</h5><p>Методы, унаследованные от Evented, смотрите <a href="/doc/maps/ru/manual/base-classes#dgevented-methods">здесь</a>.</p>
<h4 id="свойства">Свойства</h4><p>Свойства карты включают в себя обработчики взаимодействия, которые позволяют контролировать интерактивное поведение,
подключение и отключение определенных возможностей карты, таких как перетаскивание и масштабирование тачем
(см. методы <a href="/doc/maps/ru/manual/base-classes#dghandler">Handler</a>). Например:</p>
<pre><code>map.doubleClickZoom.disable();
</code></pre><p>Вы также можете получить доступ к элементам управления картой, которые включены по умолчанию, например,
к элементу управления масштабом:</p>
<pre><code>map.zoomControl.setPosition(&#39;topright&#39;);
</code></pre><h5 id="обработчики">Обработчики</h5><table>
    <thead>
        <tr>
            <th>Свойство</th>
            <th>Тип</th>
...
<h4 id="панели-карты">Панели карты</h4><p>Панели - это DOM-элементы, которые используются для контроля очередности отображения слоев на карте.
...
по умолчанию есть следующий набор панелей, которые отличаются только zIndex.</p>
<table>
    <thead>
        <tr>
            <th>Панель</th>
...
<h4 id="опции-определения местоположения">Опции определения местоположения</h4><p>Некоторые методы геолокации объекта <a href="#dgmap"><code>Map</code></a> принимают параметр
<code>options</code>. Это обычный JavaScript-объект со следующими опциональными компонентами:</p>
<table>
    <thead>
        <tr>
            <th>Опция</th>
...
<h4 id="опции-масштабирования">Опции масштабирования</h4><p>Некоторые методы объекта <a href="#dgmap"><code>Map</code></a>, которые изменяют масштаб,
принимают параметр <code>options</code>. Это обычный JavaScript-объект со следующими
необязательными компонентами:</p>
<table>
    <thead>
        <tr>
            <th>Опция</th>
...
<h4 id="опции-перемещения">Опции перемещения</h4><p>Некоторые методы объекта <a href="#dgmap"><code>Map</code></a>, которые меняют центр карты,
принимают параметр <code>options</code>. Это обычный JavaScript-объект со следующими
необязательными компонентами:</p>
<table>
    <thead>
...
<h4 id="дополнительные-опции масштабирования/перемещения">Дополнительные опции масштабирования/перемещения</h4><p>Дополнительные опции наследуются от <a href="#zoom-options">Zoom options</a> и
<a href="#pan-options">Pan options</a></p>
<h4 id="опции-соответствия границам">Опции соответствия границам</h4><table>
    <thead>
        <tr>
            <th>Опция</th>
            <th>Тип</th>
