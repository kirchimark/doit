...
.leaflet-popup-tip-container_image {
  background-repeat: no-repeat;
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__popupShadow_dark.png');
  background-size: 58px 47px;
}
.leaflet-retina .leaflet-popup-tip-container_image {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__popupShadow_dark@2x.png');
}
...
.no-touch .dg-control-round__icon:hover {
  -webkit-box-shadow: inset 0 1px #fff, 0 0 0 1px rgba(0, 0, 0, 0.3), 0 1px 0 1px rgba(0, 0, 0, 0.4);
          box-shadow: inset 0 1px #fff, 0 0 0 1px rgba(0, 0, 0, 0.3), 0 1px 0 1px rgba(0, 0, 0, 0.4);
}
.dg-control-round__icon:active,
.no-touch .dg-control-round__icon:active,
.dg-control-round__icon_state_active {
  -webkit-box-shadow: inset 0 1px 1px 1px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.3), 0 -1px 1px 0 #000;
          box-shadow: inset 0 1px 1px 1px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.3), 0 -1px 1px 0 #000;
}
.leaflet-disabled .dg-control-round__icon,
.no-touch .leaflet-disabled .dg-control-round__icon:hover,
.leaflet-disabled .dg-control-round__icon:active {
...
a.dg-popup__link {
  background-image: -webkit-gradient(linear, left top, right top, from(rgba(255, 230, 170, 0.3)), to(rgba(255, 230, 170, 0.3)));
  background-image: -webkit-linear-gradient(left, rgba(255, 230, 170, 0.3), rgba(255, 230, 170, 0.3) 100%);
  background-image: linear-gradient(to right, rgba(255, 230, 170, 0.3), rgba(255, 230, 170, 0.3) 100%);
  color: #ffe6aa;
}
.no-touch a.dg-popup__link:hover {
  background-image: -webkit-gradient(linear, left top, right top, from(rgba(153, 204, 221, 0.3)), to(rgba(153, 204, 221, 0.3)));
  background-image: -webkit-linear-gradient(left, rgba(153, 204, 221, 0.3), rgba(153, 204, 221, 0.3) 100%);
  background-image: linear-gradient(to right, rgba(153, 204, 221, 0.3), rgba(153, 204, 221, 0.3) 100%);
  color: #9cd;
}
.dg-popup__header-title {
  color: #ffc84b;
...
.dg-popup__rating {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__ratingStarOff_dark.png');
  background-size: 14px 14px;
}
.leaflet-retina .dg-popup__rating {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__ratingStarOff_dark@2x.png');
}
.dg-popup__link_type_photos:before {
  background-repeat: no-repeat;
  width: 12px;
...
.dg-schedule__today {
  background-image: -webkit-gradient(linear, left top, right top, from(rgba(230, 230, 230, 0.55)), color-stop(50%, rgba(230, 230, 230, 0.55)), color-stop(51%, rgba(0, 0, 0, 0)), to(rgba(0, 0, 0, 0)));
  background-image: -webkit-linear-gradient(left, rgba(230, 230, 230, 0.55), rgba(230, 230, 230, 0.55) 50%, rgba(0, 0, 0, 0) 51%, rgba(0, 0, 0, 0) 100%);
  background-image: linear-gradient(to right, rgba(230, 230, 230, 0.55), rgba(230, 230, 230, 0.55) 50%, rgba(0, 0, 0, 0) 51%, rgba(0, 0, 0, 0) 100%);
}
.dg-schedule__now {
  color: #aaa;
}
