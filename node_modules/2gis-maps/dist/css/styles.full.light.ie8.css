...
.leaflet-popup-content-wrapper {
  ...
  color: #e6e6e6;
  font-size: 14px;
  -webkit-transition: opacity ease-out 0.2s, max-height ease-out 0.2s, height ease-out 0.2s;
  transition: opacity ease-out 0.2s, max-height ease-out 0.2s, height ease-out 0.2s;
...
.leaflet-popup_show_true {
  -webkit-transition: opacity ease-in-out 0.2s, height ease-out 0.2s, -webkit-transform ease-in-out 0.2s;
  transition: opacity ease-in-out 0.2s, height ease-out 0.2s, -webkit-transform ease-in-out 0.2s;
  transition: transform ease-in-out 0.2s, opacity ease-in-out 0.2s, height ease-out 0.2s;
  transition: transform ease-in-out 0.2s, opacity ease-in-out 0.2s, height ease-out 0.2s, -webkit-transform ease-in-out 0.2s;
...
.leaflet-popup-tip-container_image {
  background-repeat: no-repeat;
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__popupShadow_light.png');
  background-size: 58px 47px;
}
.leaflet-retina .leaflet-popup-tip-container_image {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__popupShadow_light@2x.png');
}
.leaflet-map-pane .leaflet-popup-tip-container {
...
.dg-header__title {
  ...
  -webkit-box-sizing: border-box;
          box-sizing: border-box;
  /* For padding and border, if exist */
  background: #999;
...
.leaflet-popup-scrolled .dg-popup__container {
  /* @TODO: .leaflet-popup-scrolled → dg-popup_scrolled_true */
...
.no-touch .dg-control-round__icon:hover {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #ebebeb), to(#fff));
...
.dg-control-round__icon_state_active {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #d6d6d6), to(#fff));
...
.dg-control-round {
  background-color: #f0f0f0;
  -webkit-box-shadow: 0 0 0 1px #fff, 0 2px 5px 0 rgba(0, 0, 0, 0.3);
          box-shadow: 0 0 0 1px #fff, 0 2px 5px 0 rgba(0, 0, 0, 0.3);
}
.dg-control-round__icon {
...
.dg-zoom__out {
  -webkit-box-shadow: 0 0 0 1px #fff, 0 2px 3px 0 rgba(0, 0, 0, 0.3);
          box-shadow: 0 0 0 1px #fff, 0 2px 3px 0 rgba(0, 0, 0, 0.3);
}
.dg-zoom__out:after {
  border: solid #fff;
  border-width: 0 1px;
...
.leaflet-container .dg-attribution__link {
  background: -webkit-gradient(linear, left top, right top, from(rgba(8, 8, 8, 0.3)), to(rgba(8, 8, 8, 0.3))) 0 95% repeat-x;
  background: -webkit-linear-gradient(left, rgba(8, 8, 8, 0.3), rgba(8, 8, 8, 0.3) 100%) 0 95% repeat-x;
...
.leaflet-container .dg-attribution__link:hover {
  background-image: -webkit-gradient(linear, left top, right top, from(#080808), to(#080808));
  background-image: -webkit-linear-gradient(left, #080808, #080808 100%);
...
.no-touch .dg-control-round__icon_state_active.dg-control-round__icon_name_locate:hover:after,
...
.leaflet-retina .dg-control-round__icon_state_active.dg-control-round__icon_name_locate:after,
.leaflet-retina .no-touch .dg-control-round__icon_state_active.dg-control-round__icon_name_locate:hover:after,
.leaflet-retina .dg-control-round__icon_state_active.dg-control-round__icon_name_locate:active:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
  background-position: -55px -20px;
  background-size: 91px 71.5px;
}
...
.dg-control-round__icon_name_locate:after {
  ...
  width: 18px;
  height: 18px;
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite.light.png');
  background-position: -24px 0px;
  background-size: 77px 65px;
}
.leaflet-retina .dg-control-round__icon_name_locate:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -24px 0px;
  background-size: 77px 65px;
}
...
.leaflet-retina .no-touch .dg-control-round__icon_name_locate:hover:after,
.leaflet-retina .dg-control-round__icon_name_locate:active:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: 0px -24px;
  background-size: 77px 65px;
}
.dg-control-round__icon_state_requesting.dg-control-round__icon_name_locate:after,
.no-touch .dg-control-round__icon_state_requesting.dg-control-round__icon_name_locate:hover:after,
...
.leaflet-retina .dg-control-round__icon_state_requesting.dg-control-round__icon_name_locate:after,
.leaflet-retina .no-touch .dg-control-round__icon_state_requesting.dg-control-round__icon_name_locate:hover:after,
.leaflet-retina .dg-control-round__icon_state_requesting.dg-control-round__icon_name_locate:active:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: 0px 0px;
  background-size: 77px 65px;
}
...
.no-touch .dg-control-round__icon_state_active.dg-control-round__icon_name_fullscreen:hover:after,
...
.leaflet-retina .dg-control-round__icon_state_active.dg-control-round__icon_name_fullscreen:after,
.leaflet-retina .no-touch .dg-control-round__icon_state_active.dg-control-round__icon_name_fullscreen:hover:after,
.leaflet-retina .dg-control-round__icon_state_active.dg-control-round__icon_name_fullscreen:active:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
...
.leaflet-retina .dg-control-round__icon_name_fullscreen:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -42px 0px;
  background-size: 77px 65px;
}
...
.leaflet-retina .no-touch .dg-control-round__icon_name_fullscreen:hover:after,
.leaflet-retina .dg-control-round__icon_name_fullscreen:active:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -18px -24px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-building-callout__list-item:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -70px -22px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-map-geoclicker__address-header:first-child:before,
.leaflet-retina .dg-map-geoclicker__address-drilldown:first-child:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: 0px -54px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-map-geoclicker__purpose:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -70px 0px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-map-geoclicker__purpose_type_street:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -42px -28px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-map-geoclicker__purpose_type_sight:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -34px -24px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-map-geoclicker__purpose_type_settlement:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -42px -16px;
  background-size: 77px 65px;
}
...
.leaflet-retina a.dg-map-geoclicker__show-more-sights-link:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -70px -12px;
  background-size: 77px 65px;
}
...
.dg-preloader_animation_true.dg-preloader_scheme_regular:before {
  background-repeat: no-repeat;
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPreloader__preloaderBig.png');
  background-size: 44px 44px;
}
.leaflet-retina .dg-preloader_animation_true.dg-preloader_scheme_regular:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPreloader__preloaderBig@2x.png');
}
.dg-preloader_animation_true.dg-preloader_scheme_regular.dg-preloader_size_small:before {
  background-repeat: no-repeat;
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPreloader__preloaderSmall.png');
  background-size: 24px 24px;
}
.leaflet-retina .dg-preloader_animation_true.dg-preloader_scheme_regular.dg-preloader_size_small:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPreloader__preloaderSmall@2x.png');
}
...
.dg-preloader_animation_true.dg-preloader_scheme_regular:after {
  background-repeat: no-repeat;
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPreloader__preloaderBigInner.png');
  background-size: 32px 32px;
}
.leaflet-retina .dg-preloader_animation_true.dg-preloader_scheme_regular:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPreloader__preloaderBigInner@2x.png');
}
.dg-preloader_animation_true.dg-preloader_scheme_regular.dg-preloader_size_small:after {
  background-repeat: no-repeat;
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPreloader__preloaderSmallInner.png');
  background-size: 12px 12px;
}
.leaflet-retina .dg-preloader_animation_true.dg-preloader_scheme_regular.dg-preloader_size_small:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPreloader__preloaderSmallInner@2x.png');
}
...
.dg-popup__rating-stars {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__ratingStar.png');
  background-size: 14px 14px;
  float: left;
  height: 100%;
}
.leaflet-retina .dg-popup__rating-stars {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__ratingStar@2x.png');
}
.dg-popup__link {
  position: relative;
...
.leaflet-retina .dg-popup__link_type_booklet:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
...
a.dg-popup__link {
  background-image: -webkit-gradient(linear, left top, right top, from(rgba(0, 91, 143, 0.3)), to(rgba(0, 91, 143, 0.3)));
  background-image: -webkit-linear-gradient(left, rgba(0, 91, 143, 0.3), rgba(0, 91, 143, 0.3) 100%);
  background-image: linear-gradient(to right, rgba(0, 91, 143, 0.3), rgba(0, 91, 143, 0.3) 100%);
  color: #005b8f;
}
.no-touch a.dg-popup__link:hover {
  ...
  background-image: -webkit-linear-gradient(left, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3) 100%);
  background-image: linear-gradient(to right, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3) 100%);
  color: #000;
}
.dg-popup__footer-button-wrapper .dg-popup__footer-button {
  color: #647882;
}
.no-touch .dg-popup__footer-button-wrapper .dg-popup__footer-button:hover {
  color: #286482;
}
.dg-popup__footer-button {
...
.dg-popup__rating {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__ratingStarOff_light.png');
  background-size: 14px 14px;
}
.leaflet-retina .dg-popup__rating {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGPopup__ratingStarOff_light@2x.png');
}
.dg-popup__link_type_photos:before {
  background-repeat: no-repeat;
  width: 12px;
...
.leaflet-retina .dg-popup__link_type_photos:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -58px -33px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-popup__button_name_firm-card-back:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -9px -54px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-popup__button_name_firm-list-back:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -9px -54px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-popup__button_name_back:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -9px -54px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-popup__button_name_goto:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -12px -42px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-popup__button_name_show-entrance:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: 0px -42px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-firm-card__address:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: 0px -54px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-firm-card__phone:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -58px -43px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-firm-card__site:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -58px -22px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-firm-card__email:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -32px -42px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-schedule_open_true .dg-schedule__today:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
...
.dg-schedule__today {
  background-image: -webkit-gradient(linear, left top, right top, from(rgba(0, 0, 0, 0.55)), color-stop(50%, rgba(0, 0, 0, 0.55)), color-stop(51%, rgba(0, 0, 0, 0)), to(rgba(0, 0, 0, 0)));
  background-image: -webkit-linear-gradient(left, rgba(0, 0, 0, 0.55), rgba(0, 0, 0, 0.55) 50%, rgba(0, 0, 0, 0) 51%, rgba(0, 0, 0, 0) 100%);
  background-image: linear-gradient(to right, rgba(0, 0, 0, 0.55), rgba(0, 0, 0, 0.55) 50%, rgba(0, 0, 0, 0) 51%, rgba(0, 0, 0, 0) 100%);
}
.dg-schedule__now {
  color: #666;
}
...
.leaflet-retina .dg-schedule__table-clock {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -58px -11px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-schedule__table-lunch {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -58px 0px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-schedule_open_false .dg-schedule__today:before {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -58px -11px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-schedule__today:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -43px -42px;
  background-size: 77px 65px;
}
...
.leaflet-retina .dg-schedule__today_shown_true:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.light.png');
  background-position: -24px -18px;
  background-size: 77px 65px;
}
...
.dg-link_type_local {
  background: -webkit-gradient(linear, left top, right top, from(#99ccdd), color-stop(50%, #99ccdd), color-stop(50%, transparent));
  background: -webkit-linear-gradient(left, #99ccdd, #99ccdd 50%, transparent 50%);
  background: linear-gradient(to right, #99ccdd, #99ccdd 50%, transparent 50%);
}
.no-touch .dg-link_type_local:hover {
  background: -webkit-gradient(linear, left top, right top, from(#99bbcc), color-stop(50%, #99bbcc), color-stop(50%, transparent));
  background: -webkit-linear-gradient(left, #99bbcc, #99bbcc 50%, transparent 50%);
...
.dg-schedule__tc_active_true {
  filter: progid:DXImageTransform.Microsoft.gradient(GradientType=0,startColorstr='#66e6e6e6',endColorstr='#66e6e6e6');
}
...
.leaflet-retina .dg-control-round__icon_name_traffic:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
  background-position: -55px -38px;
  background-size: 91px 71.5px;
}
...
.leaflet-retina .no-touch .dg-control-round__icon_name_traffic:hover:after,
.leaflet-retina .dg-control-round__icon_name_traffic:active:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
  background-position: 0px -57.5px;
  background-size: 91px 71.5px;
}
.dg-control-round__icon_state_active.dg-control-round__icon_name_traffic:after,
.no-touch .dg-control-round__icon_state_active.dg-control-round__icon_name_traffic:hover:after,
...
a.dg-traffic-control_color_red:after {
  ...
  height: 22px;
  border-radius: 50%;
  -webkit-box-shadow: inset 0 1px 0 0 rgba(0, 0, 0, 0.2), 0 1px 0 0 #fff;
          box-shadow: inset 0 1px 0 0 rgba(0, 0, 0, 0.2), 0 1px 0 0 #fff;
}
...
a.dg-traffic-control_color_green:active:after {
  background: -webkit-gradient(linear, left bottom, left top, from(#2aa731), to(#53e13a)) #3ec435;
...
a.dg-traffic-control_color_yellow:active:after {
  background: -webkit-gradient(linear, left bottom, left top, from(#ef931b), to(#f7be26)) #f4a820;
...
a.dg-traffic-control_color_red:active:after {
  background: -webkit-gradient(linear, left bottom, left top, from(#c01c0a), to(#f73416)) #db2811;
  background: -webkit-linear-gradient(bottom, #c01c0a, #f73416) #db2811;
  background: linear-gradient(to top, #c01c0a, #f73416) #db2811;
}

.no-touch .dg-traffic-control_color_green {
  background: #3fc03b !important;
  font-weight: bold;
}
.no-touch .dg-traffic-control_color_yellow {
  background: #f3b223 !important;
  font-weight: bold;
}
.no-touch .dg-traffic-control_color_red {
...
.leaflet-retina .dg-ruler__label-remove-link {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
...
.dg-ruler__point {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGRuler__point.png');
  background-size: 10px 10px;
}
.leaflet-retina .dg-ruler__point {
  background-image: url('https://maps.api.2gis.ru/2.0/img/DGRuler__point@2x.png');
}
.dg-ruler__label-container {
  background: #0da5d5;
}
...
.leaflet-retina .dg-control-round__icon_name_ruler:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
...
.leaflet-retina .no-touch .dg-control-round__icon_name_ruler:hover:after,
.leaflet-retina .dg-control-round__icon_name_ruler:active:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
  background-position: -75px -46px;
  background-size: 91px 71.5px;
}
.dg-control-round__icon_state_active.dg-control-round__icon_name_ruler:after,
.no-touch .dg-control-round__icon_state_active.dg-control-round__icon_name_ruler:hover:after,
...
.leaflet-retina .dg-control-round__icon_state_active.dg-control-round__icon_name_ruler:after,
.leaflet-retina .no-touch .dg-control-round__icon_state_active.dg-control-round__icon_name_ruler:hover:after,
.leaflet-retina .dg-control-round__icon_state_active.dg-control-round__icon_name_ruler:active:after {
  background-image: url('https://maps.api.2gis.ru/2.0/img/sprite@2x.basic.png');
